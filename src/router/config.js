...
export const protectedRoute = [{
    ...
    //media
    {
        ...
        component: () =>
            import ( /* webpackChunkName: "routes" */ `@/views/Media.vue`)
    },
    ...
    //mail app
    {
        ...
        name: "Mail",
        component: () =>
            import ( /* webpackChunkName: "routes" */ `@/components/email/Layout.vue`),
        redirect: {
            path: "/mail/all"
        },
        children: [{
                ...
                name: "MailIndex",
                component: () =>
                    import ( /* webpackChunkName: "routes" */ `@/components/email/List.vue`)
            },
            {
                path: "/mail/0/:uuid",
                meta: {
                ...
                name: "MailDetail",
                component: () =>
                    import ( /* webpackChunkName: "routes" */ `@/components/email/Reply.vue`)
            }
        ]
    }
]